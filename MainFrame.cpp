...
{
    SetBackgroundColour(wxColour(102, 178, 255));
    ...
    wxStaticText* headlineText = new wxStaticText(panel, wxID_ANY, "Contact Book",  //header title
        wxPoint(325, 22), wxSize(800, -1));
    headlineText->SetForegroundColour(wxColour(255,255,255));


    headlineText->SetFont(headlineFont);

    addButton = new wxButton(panel, wxID_ANY, "Add Contact", wxPoint(100, 225), wxSize(200, 35));
    addButton->SetForegroundColour(wxColour(*wxBLACK));
    addButton->SetFont(bottons);

    searchButton = new wxButton(panel, wxID_ANY, "Search contact", wxPoint(100, 325), wxSize(200, 35));
    searchButton->SetForegroundColour(wxColour(*wxBLACK)); 
    searchButton->SetFont(bottons);

    deleteButton = new wxButton(panel, wxID_ANY, "Delete Contact", wxPoint(100, 425), wxSize(200, 35));
    deleteButton->SetForegroundColour(wxColour(*wxBLACK));
    deleteButton->SetFont(bottons);

    deleteAll = new wxButton(panel, wxID_ANY, "Delete All", wxPoint(100, 525), wxSize(200, 35));
    deleteAll->SetForegroundColour(wxColour(*wxBLACK));
    deleteAll ->SetFont(bottons);

    wxStaticBox* descriptionBox = new wxStaticBox(panel, wxID_ANY, "", wxPoint(351, 135), wxSize(448, 50));
    descriptionText = new wxStaticText(descriptionBox, wxID_ANY, "Name                             Number", wxPoint(5, 15), wxSize(200, 35));
    descriptionText->SetFont(bottons);
    descriptionText->SetForegroundColour(wxColour(255, 255, 255));


    contactListBox = new wxListBox(panel, wxID_ANY, wxPoint(350, 180), wxSize(225,450));
    numberListBox = new wxListBox(panel, wxID_ANY, wxPoint(575, 180), wxSize(225, 450));
...
void ContactBookFrame::OnDisplayBox()
{
    BubbleSort();
    Node* temp = head;
    wxString contactsInfo;
    ...
    numberListBox->Clear();
        ...
        {
            contactsInfo = wxString::Format("%s", temp->name.c_str());
            contactListBox->Append(contactsInfo);

            contactsInfo = wxString::Format("%s\n", temp->phone_number.c_str());
            numberListBox->Append(contactsInfo);
            temp = temp->next;
        }
